...
ActiveRecord::Schema.define(version: 20180525135715) do
  ...
  create_table "delayed_jobs", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "error_message",               limit: 191
    t.string   "delayed_reference_type",      limit: 191
    t.integer  "delayed_reference_id",        limit: 4
    t.string   "delayed_global_reference_id", limit: 191
  end
  ...
  create_table "exports", force: :cascade do |t|
    ...
    t.string   "default_namespace", limit: 191
  end
  ...
  create_table "imports", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.datetime "finished_at"
    t.string   "import_file",       limit: 191
    t.boolean  "publish"
    t.string   "default_namespace", limit: 191
  end
  ...
  add_index "note_annotations", ["value"], name: "index_note_annotations_on_value", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "password_salt",     limit: 191
    t.string   "persistence_token", limit: 191
    t.string   "perishable_token",  limit: 191
    t.string   "role",              limit: 191
    t.string   "telephone_number",  limit: 191
    t.string   "type",              limit: 191, default: "User"
  end
